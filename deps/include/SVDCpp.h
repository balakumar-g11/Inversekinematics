...
// from a DLL simpler. All files within this DLL are compiled with the SVDCPP_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// SVDCPP_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
#ifdef SVDCPP_EXPORTS
#define SVDCPP_API __declspec(dllexport)
#else
//#define SVDCPP_API __declspec(dllimport)
#define SVDCPP_API 
#endif
...
// This class is exported from the SVDCpp.dll
class ap_error
{
public:
...
********************************************************************/
template<class T>
class SVDCPP_API template_2d_array
{
public:
    template_2d_array()
    {
...
class SVDCPP_API GeneralMatrix
{
public:	
	GeneralMatrix(int a, int b);		
	GeneralMatrix(int a, int b, double s);
	GeneralMatrix(int a, int b, ap::real_2d_array ab);
	GeneralMatrix Transpose();
	GeneralMatrix UnaryMinus();
	GeneralMatrix Add(GeneralMatrix B);
	GeneralMatrix Subtract(GeneralMatrix B);
	GeneralMatrix Multiply(GeneralMatrix B);
	GeneralMatrix Multiply(double s);
	GeneralMatrix ElementMultiply(GeneralMatrix B);
	GeneralMatrix MatrixInverse();
	GeneralMatrix Solve(GeneralMatrix B);
	ap::real_2d_array GetMatrix();	
private:
	int m;
	int n;
	ap::real_2d_array A;
	bool CheckMatrixDimensions(GeneralMatrix B);
};
